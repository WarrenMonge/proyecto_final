...
marcas_modelos = {
    "toyota": {"yaris": 2, "corolla": 2, "tacoma": 0},
    "nissan": {"kicks": 0, "murano": 2, "rogue": 0},
    "hyundai": {"santaFe": 0, "tucson": 2, "venue": 0}
}
...
def guardar_reserva(marca, modelo, datos_cliente):
    with open("reservas.txt", "a") as archivo:
        archivo.write(f"Marca: {marca}, Modelo: {modelo}\n")
...
def hacer_reserva(marcas_modelos, sedes_horarios):
